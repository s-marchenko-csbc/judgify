...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self._create_materials(competitions)
    ...
    def _create_materials(self, competitions):
        for comp in competitions:
            CompetitionMaterial.objects.get_or_create(
                competition=comp,
                name="Competition rules",
                defaults={
                    "material_type": "rules",
                    "url": f"https://example.com/materials/{comp.slug or comp.id}/rules.pdf",
                    "sort_order": 0,
                },
            )
            CompetitionMaterial.objects.get_or_create(
                ...
                defaults={
                    ...
                    "url": f"https://example.com/materials/{comp.slug or comp.id}/starter.zip",
                    "sort_order": 1,
                },
            )
            ...
            for cert_idx in range(1, certificate_count + 1):
                ...
                cert_file, _ = UserFile.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "size_bytes": 128000 + cert_idx * 1024,
